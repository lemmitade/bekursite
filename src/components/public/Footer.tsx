        ...
        <div className="footer__grid">
          <div>
            ...
            <div className="footer__social">
              {settings.tiktokUrl && (
                <a href={settings.tiktokUrl} target="_blank" rel="noopener noreferrer" className="footer__social-link" aria-label="TikTok">
          ...
          <div>
            ...
            <Link href="/sister-companies" className="footer__link">Sister Companies</Link>
